...
export function getMessagePost({ title }) {
  const content = {
    zh_cn: {
      title,
      content: [
        [
          ...
          {
            tag: "md",
            text: "**Time**: **<local_datetime format_type='date_num'></local_datetime> <local_datetime format_type='time_sec'></local_datetime> (<local_datetime format_type='timezone'></local_datetime>)**",
            style: ["bold", "underline"],
          },
        ],
      ],
